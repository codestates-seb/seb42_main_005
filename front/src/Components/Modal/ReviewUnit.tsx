    ...
    <>
      <ReviewUnitContainer>
        <section>
          <Upper>
            <UserInfo>
              <UserIcon src={reviewList.userImage} alt="일반계정 사용자의 이미지 입니다." />
              <UserName>{reviewList.name}</UserName>
        ...
        {reviewList.comments?.map((el: any) => (
          <ReviewOfReview el={el} key={el.commentIdx} />
        ))}
